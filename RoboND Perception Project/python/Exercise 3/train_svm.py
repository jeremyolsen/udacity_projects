...
# parameters = {'kernel':('linear', 'rbf'), 'C': C_range, 'gamma': gamma_range, 'class_weight':['balanced', None]}
# svr = svm.SVC()
...
clf.fit(X, y_train)
#clf = svm.NuSVC(kernel='rbf', probability=True, shrinking=False, decision_function_shape='ovo')
#clf = svm.LinearSVC()
