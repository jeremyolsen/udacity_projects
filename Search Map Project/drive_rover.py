...
def telemetry(sid, data):
    ...
    global frame_counter, second_counter, fps, origin_position_stored
    frame_counter+=1
    ...
    if data:
        ...
        if np.isfinite(Rover.vel):
            ...
            #Store off origin position for use for return home
            if not origin_position_stored:
                Rover.origin_position = Rover.pos
                origin_position_stored = True
